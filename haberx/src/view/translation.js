...
Candy.View.Translation = {
	'en' : {
		'status': 'Status: %s',
		'statusConnecting': 'Spajam se...',
		'statusConnected' : 'Spojen',
		'statusDisconnecting': 'Diskonektujem se...',
		'statusDisconnected' : 'Disconnected',
		'statusAuthfail': 'Problem sa autorizacijom',
		...
		'userLeftRoom'             : '%s je otišao učiti.',
